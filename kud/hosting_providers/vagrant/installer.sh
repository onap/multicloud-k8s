...
echo "Removing ppa for jonathonf/ubuntu/python-3.6"
sudo add-apt-repository -r ppa:jonathonf/ubuntu/python-3.6
sudo add-apt-repository -r ppa:jonathonf/ubuntu/
sudo apt-get update
install_k8s
