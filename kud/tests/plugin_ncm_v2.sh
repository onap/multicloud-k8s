...
delete_resource "${base_url}/cluster-providers/${cluster_provider_name1}/clusters/${clusterName1}/labels/${clusterLabel1}"
delete_resource "${base_url}/cluster-providers/${cluster_provider_name2}/clusters/${clusterName2}/labels/${clusterLabel2}"


print_msg "Deleting the cluster1 and cluster2, if they were existing"
