...
if [ $return_status == 405 ]
then
print_msg "Test: composite application post-2 expected value = 405 actual value = $return_status PASSED"
else
print_msg "Test: composite application post-2 expected value = 405 actual value = $return_status FAILED"
fi
