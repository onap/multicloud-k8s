...
#TEST-2
#delete a null project should return error code 400 or 500
project_name=""
...
if [ $return_status == 404 ] ;then
    ...
    print_msg "Test:project-delete-2 with invalid project name. Expected = 404, \
