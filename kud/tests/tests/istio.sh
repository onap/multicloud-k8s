...
base_dest=$(grep "base_dest:" $test_folder/../../kud_deployment_infra/playbooks/kud-vars.yml | awk -F ': ' '{print $2}')
istio_dest=$(grep "istio_dest:" $test_folder/../../kud_deployment_infra/playbooks/kud-vars.yml | awk -F ': ' '{print $2}' | sed "s|{{ base_dest }}|$base_dest|g;s|\"||g")
istio_version=$(grep "istio_version:" $test_folder/../../kud_deployment_infra/playbooks/kud-vars.yml | awk -F ': ' '{print $2}')
