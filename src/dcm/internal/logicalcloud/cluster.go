...
type ClusterManager interface {
    Create(project, logicalCloud string, c Cluster) (Cluster, error)
    Get(project, logicalCloud, name string) (Cluster, error)
    GetAll(project, logicalCloud string) ([]Cluster, error)
    Delete(project, logicalCloud, name string) error
    Update(project, logicalCloud, name string, c Cluster) (Cluster, error)
}
...
func (v *ClusterClient) Create(project, logicalCloud string, c Cluster) (Cluster, error) {
    ...
    _, err = v.Get(project, logicalCloud, c.MetaData.ClusterReference)
    if err == nil {
...
func (v *ClusterClient) Get(project, logicalCloud, clusterReference string)(Cluster, error) {
...
func (v *ClusterClient) GetAll(project, logicalCloud string)([]Cluster, error) {
...
func (v *ClusterClient) Delete(project, logicalCloud, clusterReference string) error {
    //Construct the composite key to select the entry
    key := ClusterKey{
        Project:            project,
        LogicalCloudName:   logicalCloud,
...
func (v *ClusterClient) Update(project, logicalCloud, clusterReference string, c Cluster) (Cluster, error) {
    ...
    _, err := v.Get(project, logicalCloud, clusterReference)
    if err != nil {
