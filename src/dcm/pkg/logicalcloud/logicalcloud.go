...
type LogicalCloudKey struct {
    ...
    LogicalCloudName    string  `json:"lcname"`
}
...
type Utility interface {
    DBInsert(storeName string, key interface{}, query interface{}, meta string, c interface{}) error
    DBFind(storeName string, key interface{}, meta string) ([][]byte, error)
    DBUnmarshal(value []byte, data interface{}) error
    DBRemove(storeName string, key interface{}) error
...
func (d DBService) DBInsert(storeName string, key interface{}, query interface{}, meta string, c interface{}) error {
...
func (d DBService) DBFind(storeName string, key interface{}, meta string) ([][]byte, error) {

    value, err := db.DBconn.Find(storeName, key, meta)
    if err != nil {
        return [][]byte{}, pkgerrors.Wrap(err, "Get Logical Cloud")
    }

    return value, nil
}

func (d DBService) DBUnmarshal(value []byte, data interface{}) error {

    err := db.DBconn.Unmarshal(value, &data)
    if err != nil {
...
func (d DBService) DBRemove(storeName string, key interface{}) error {
