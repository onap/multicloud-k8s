...
func (m *mockValues) DBInsert(name string, key interface {}, query interface {}, meta string, c interface {}) error{
...
func (m *mockValues) DBFind(name string, key interface {}, meta string) ([][]byte, error) {
...
func (m *mockValues) DBRemove(name string, key interface {}) error {
