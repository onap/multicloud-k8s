...
func (v *ProjectClient) CreateProject(p Project) (Project, error) {
	...
	err = main.DBconn_Controller.Create(v.storeName, key, v.tagMeta, p)
	if err != nil {
...
func (v *ProjectClient) GetProject(name string) (Project, error) {
	...
	value, err := main.DBconn_Controller.Read(v.storeName, key, v.tagMeta)
	if err != nil {
	...
	if value != nil {
		proj := Project{}
		err = main.DBconn_Controller.Unmarshal(value, &proj)
		if err != nil {
...
func (v *ProjectClient) DeleteProject(name string) error {
	...
	err := main.DBconn_Controller.Delete(v.storeName, key, v.tagMeta)
	if err != nil {
