...
func (v *ProjectClient) CreateProject(p Project) (Project, error) {
	...
	err = controllerdb.DBconn["mco"].Create(v.storeName, key, v.tagMeta, p)
	if err != nil {
...
func (v *ProjectClient) GetProject(name string) (Project, error) {
	...
	value, err := controllerdb.DBconn["mco"].Read(v.storeName, key, v.tagMeta)
	if err != nil {
	...
	if value != nil {
		proj := Project{}
		err = controllerdb.DBconn["mco"].Unmarshal(value, &proj)
		if err != nil {
...
func (v *ProjectClient) DeleteProject(name string) error {
	...
	err := controllerdb.DBconn["mco"].Delete(v.storeName, key, v.tagMeta)
	if err != nil {
