...
func (m *MockVNFDefinition) CreateVNFDefinition(inp vnfd.VNFDefinition) (vnfd.VNFDefinition, error) {
...
func (m *MockVNFDefinition) ListVNFDefinitions() ([]vnfd.VNFDefinition, error) {
	return []vnfd.VNFDefinition{
		{
			UUID:        "123e4567-e89b-12d3-a456-426655440000",
			Name:        "testvnf",
...
func (m *MockVNFDefinition) GetVNFDefinition(vnfID string) (vnfd.VNFDefinition, error) {
	return vnfd.VNFDefinition{
		UUID:        "123e4567-e89b-12d3-a456-426655440000",
		Name:        "testvnf",
		Description: "test description",
...
func (m *MockVNFDefinition) DeleteVNFDefinition(vnfID string) error {
	return nil
}

func init() {
	mockImpl := MockVNFDefinition{}
	vh = vnfdHandler{vnfdImpl: &mockImpl}
}
