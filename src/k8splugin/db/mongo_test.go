...
func TestHealthCheck(t *testing.T) {
	testCases := []struct {
		...
		{
			label: "Successfull Healthcheck",
			// Binary form of
			// {
			//	"_id" : ObjectId("5c119dbf35792787f25309b6"),
			//  "key" : "7eb09e38-4363-9942-80d6-3beb2e95fd84",
			//  "healtcheck" : ObjectId("5c115158c9755047e318bbfc")
			// }
			bson: bson.Raw{
				'\x5d', '\x00', '\x00', '\x00', '\x07', '\x5f', '\x69', '\x64',
				'\x00', '\x5c', '\x11', '\x9d', '\xbf', '\x35', '\x79', '\x27',
				'\x87', '\xf2', '\x53', '\x09', '\xb6', '\x02', '\x6b', '\x65',
				'\x79', '\x00', '\x25', '\x00', '\x00', '\x00', '\x37', '\x65',
				'\x62', '\x30', '\x39', '\x65', '\x33', '\x38', '\x2d', '\x34',
				'\x33', '\x36', '\x33', '\x2d', '\x39', '\x39', '\x34', '\x32',
				'\x2d', '\x38', '\x30', '\x64', '\x36', '\x2d', '\x33', '\x62',
				'\x65', '\x62', '\x32', '\x65', '\x39', '\x35', '\x66', '\x64',
				'\x38', '\x34', '\x00', '\x07', '\x68', '\x65', '\x61', '\x6c',
				'\x74', '\x68', '\x63', '\x68', '\x65', '\x63', '\x6b', '\x00',
				'\x5c', '\x11', '\x51', '\x58', '\xc9', '\x75', '\x50', '\x47',
				'\xe3', '\x18', '\xbb', '\xfc', '\x00',
			},
			mockColl: &mockCollection{},
		},
		{
			label: "UnSuccessfull Healthcheck",
			mockColl: &mockCollection{
...
func TestReadAll(t *testing.T) {
	testCases := []struct {
		...
		{
			label: "Successfull Readall of entry",
			input: map[string]interface{}{
				"coll": "collname",
				"tag":  "metadata",
			},
		...
		{
			label: "UnSuccessfull Readall of entry",
			input: map[string]interface{}{
				"coll": "collname",
				"tag":  "tagName",
			},
