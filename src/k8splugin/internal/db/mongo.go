...
func (m *MongoStore) Create(coll string, key DBKey, tag string, data interface{}) error {
...
func (m *MongoStore) Read(coll string, key DBKey, tag string) ([]byte, error) {
...
func (m *MongoStore) Delete(coll string, key DBKey, tag string) error {
	if !m.validateParams(coll, key, tag) {
