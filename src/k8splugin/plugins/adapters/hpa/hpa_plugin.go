...
func (p hpaPlacementPlugin) GetSites(intentName string, resourceBundleName string, sites []string) (map[string]string, error) {
	return make(map[string]string), errors.New("Error")
}
...
func (p hpaPlacementPlugin) GetFeatures(clusterName string) (map[string]string, error) {
	return make(map[string]string), errors.New("Error")
}
