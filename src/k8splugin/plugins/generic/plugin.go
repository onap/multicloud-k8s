...
func (g genericPlugin) Create(yamlFilePath string, namespace string, client plugin.KubernetesConnector, isDryrun bool) (string, error) {
	if namespace == "" {
		namespace = "default"
	}
	...
	case meta.RESTScopeNameNamespace:
		createdObj, err = dynClient.Resource(gvr).Namespace(namespace).Create(context.TODO(), unstruct, createOptions)
	case meta.RESTScopeNameRoot:
		createdObj, err = dynClient.Resource(gvr).Create(context.TODO(), unstruct, createOptions)
	default:
