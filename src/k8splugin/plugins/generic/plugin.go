...
func Delete(name string, namespace string, client app.KubernetesClient) error {
	if namespace == "" {
		namespace = "default"
	}
	...
	err := dynClient.Resource(gvr).Namespace(namespace).Delete(name, metav1.CreateOptions{})
	if err != nil {
