...
// DefinitionInterface is an interface exposes the resource bundle definition functionality
...
// DefinitionClient implements the DefinitionInterface
// It will also be used to maintain some localized state
type DefinitionClient struct {
	keyPrefix string
}

// GetDefinitionClient Returns an instance of the DefinitionClient
// which implements the DefinitionInterface
// Uses rb/def prefix
func GetDefinitionClient() *DefinitionClient {
...
func (v *DefinitionClient) Get(id string) (Definition, error) {
	...
	if err != nil {
		return Definition{}, pkgerrors.Wrap(err, "Get Resource Bundle Definitions")
	}
