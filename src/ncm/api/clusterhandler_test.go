...
func (m *mockClusterManager) CreateClusterLabel(provider, cluster string, inp cluster.ClusterLabel) (cluster.ClusterLabel, error) {
	if m.Err != nil {
...
func (m *mockClusterManager) GetClusterLabel(provider, cluster, label string) (cluster.ClusterLabel, error) {
	if m.Err != nil {
		return cluster.ClusterLabel{}, m.Err
	}
...
func (m *mockClusterManager) GetClusterLabels(provider, cluster string) ([]cluster.ClusterLabel, error) {
	if m.Err != nil {
		return []cluster.ClusterLabel{}, m.Err
	}
...
func (m *mockClusterManager) CreateClusterKvPairs(provider, cluster string, inp cluster.ClusterKvPairs) (cluster.ClusterKvPairs, error) {
	if m.Err != nil {
...
func (m *mockClusterManager) GetClusterKvPairs(provider, cluster, kvpair string) (cluster.ClusterKvPairs, error) {
	if m.Err != nil {
		return cluster.ClusterKvPairs{}, m.Err
	}
...
func (m *mockClusterManager) GetAllClusterKvPairs(provider, cluster string) ([]cluster.ClusterKvPairs, error) {
	if m.Err != nil {
		return []cluster.ClusterKvPairs{}, m.Err
	}
