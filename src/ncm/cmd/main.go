...
func main() {
	...
	/* skip this for now - leave as manual admin step
	 * though - seems like it could be useful to at least check if
	 * any existing db config matches/mismatches with actual
