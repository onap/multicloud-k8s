...
func NewRouter(projectClient moduleLib.ProjectManager, microserviceClient moduleLib.MicroserviceManager) *mux.Router {
	...
	router.HandleFunc("/microservices", microservHandler.createHandler).Methods("POST")
	router.HandleFunc("/microservices", microservHandler.createHandler).Methods("PUT")
	router.HandleFunc("/microservices/{microservice-name}", microservHandler.getHandler).Methods("GET")
	router.HandleFunc("/microservices/{microservice-name}", microservHandler.deleteHandler).Methods("DELETE")
	return router
}