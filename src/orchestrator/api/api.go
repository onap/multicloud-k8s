...
func NewRouter(projectClient moduleLib.ProjectManager, compositeAppClient moduleLib.CompositeAppManager, compositeProfileClient moduleLib.CompositeProfileManager, ControllerClient moduleLib.ControllerManager) *mux.Router {
	...
	router.HandleFunc("/projects/{project-name}/composite-apps/{composite-app-name}/{version}/composite-profiles", compProfilepHandler.createHandler).Methods("POST")
	router.HandleFunc("/projects/{project-name}/composite-apps/{composite-app-name}/{version}/composite-profiles/{composite-profile-name}", compProfilepHandler.getHandler).Methods("GET")
	router.HandleFunc("/projects/{project-name}/composite-apps/{composite-app-name}/{version}/composite-profiles/{composite-profile-name}", compProfilepHandler.deleteHandler).Methods("DELETE")
