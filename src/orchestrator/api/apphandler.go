...
func (h appHandler) createHandler(w http.ResponseWriter, r *http.Request) {
	...
	a.FileContent = base64.StdEncoding.EncodeToString(content)
...
func (h appHandler) getHandler(w http.ResponseWriter, r *http.Request) {
	...
	// retAppMeta := moduleLib.App{Metadata: ret.Metadata}
	retApp := ret.Metadata
	...
	case "multipart/form-data":
		...
		fcBytes, err := base64.StdEncoding.DecodeString(fileContent)
		if err != nil {
			http.Error(w, err.Error(), http.StatusInternalServerError)
			return
		}
