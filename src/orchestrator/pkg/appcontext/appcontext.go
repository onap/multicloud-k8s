...
// CreateCompositeApp method takes in the meta data of app and returns composite app handle as interface.
// TODO: Remove meta from signature. Add a new function addCompositeAppMeta with the same sign but returning only error
