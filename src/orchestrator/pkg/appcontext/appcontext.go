...
/*
GetGroupMap shall take in appName and a list of clusternames and returns a map showing the grouping among the cluster.
sample output: {"GroupMap":{"1":["cluster_provider1+clusterName3","cluster_provider1+clusterName5"],"2":["cluster_provider2+clusterName4","cluster_provider2+clusterName6"]}
*/
