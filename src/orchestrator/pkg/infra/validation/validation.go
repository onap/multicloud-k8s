...
// default name check - conforms to length and format as defined by above constants
...
const VALID_NAME_STR string = "NAME" // uses validNameRegEx above as the match
...
var validBase64StrRegEx = regexp.MustCompile("^[A-Za-z0-9+/\r\n]+={0,2}$")
