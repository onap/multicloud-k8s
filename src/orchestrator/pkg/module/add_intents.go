...
func (c *IntentClient) AddIntent(a Intent, p string, ca string, v string, di string) (Intent, error) {
	...
	// res, err := c.GetAddIntent(a.MetaData.Name, p, ca, v, di)
	// if !reflect.DeepEqual(res, AddIntent{}) {
	// 	return AddIntent{}, pkgerrors.New("AppIntent already exists")
	// }

	//Check if project exists
	// _, err = NewProjectClient().GetProject(p)
	// if err != nil {
	// 	return AddIntent{}, pkgerrors.New("Unable to find the project")
	// }

	// check if compositeApp exists
	// _, err = NewCompositeAppClient().GetCompositeApp(ca, v, p)
	// if err != nil {
	// 	return AddIntent{}, pkgerrors.New("Unable to find the composite-app")
	// }

	// check if DeploymentIntentGroup exists
	// _, err = NewDeploymentIntentGroupClient().GetDeploymentIntentGroup(di, p, ca, v)
	// if err != nil {
	// 	return AddIntent{}, pkgerrors.New("Unable to find the intent")
	// }
