...
type AppProfileManager interface {
	...
	GetAppProfile(project, compositeApp, compositeAppVersion, compositeProfile, name string) (AppProfile, error)
	GetAppProfiles(project, compositeApp, compositeAppVersion, compositeProfile string) ([]AppProfile, error)
	GetAppProfileContent(project, compositeApp, compositeAppVersion, compositeProfile, name string) (AppProfileContent, error)
	DeleteAppProfile(project, compositeApp, compositeAppVersion, compositeProfile, name string) error
}
...
func (c *AppProfileClient) CreateAppProfile(project, compositeApp, compositeAppVersion, compositeProfile string, ap AppProfile, ac AppProfileContent) (AppProfile, error) {
	...
	err = db.DBconn.Insert(c.storeName, key, nil, c.tagMeta, ap)
	if err != nil {
		return AppProfile{}, pkgerrors.Wrap(err, "Creating DB Entry")
	}
	err = db.DBconn.Insert(c.storeName, key, nil, c.tagContent, ac)
	if err != nil {
		return AppProfile{}, pkgerrors.Wrap(err, "Creating DB Entry")
	}
...
func (c *AppProfileClient) GetAppProfile(project, compositeApp, compositeAppVersion, compositeProfile, name string) (AppProfile, error) {
	key := AppProfileKey{
		Project:             project,
		CompositeApp:        compositeApp,
		CompositeAppVersion: compositeAppVersion,
...
func (c *AppProfileClient) GetAppProfileContent(project, compositeApp, compositeAppVersion, compositeProfile, name string) (AppProfileContent, error) {
	key := AppProfileKey{
		Project:             project,
		CompositeApp:        compositeApp,
		CompositeAppVersion: compositeAppVersion,
...
func (c *AppProfileClient) DeleteAppProfile(project, compositeApp, compositeAppVersion, compositeProfile, name string) error {
	key := AppProfileKey{
		Project:             project,
		CompositeApp:        compositeApp,
		CompositeAppVersion: compositeAppVersion,
