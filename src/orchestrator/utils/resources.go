...
func GetPodNfnAnnotation(pt *v1core.PodTemplateSpec) (NfnAnnotation, error) {
...
func ParseResource(r interface{}) (interface{}, error) {
	switch o := r.(type) {
	case *batch.Job:
		return o, nil
	...
	return nil, pkgerrors.Errorf("Unsupported resource")
}
...
func AddNfnAnnotation(r interface{}, new NfnAnnotation) error {
	...
	case *v1core.Pod:
		fmt.Printf("GOT A JOB\n")
		nfnAnnotation := GetPodNfnAnnotation(&o.Spec.Template)
