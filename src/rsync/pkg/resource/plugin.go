...
import (
	...
	utils "rsync/pkg/internal"
	"rsync/pkg/internal/config"
...
func (g GenericPlugin) DeleteByNameAndKind(yamlFilePath string, resname string, namespace string, client plugin.KubernetesConnector) error {
        if namespace == "" {
                namespace = "default"
        }
